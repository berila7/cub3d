...
/*   Updated: 2025/09/30 17:25:38 by mberila          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_player(void)
{
	...
	pl = data()->player;
	new_p.x = pl->x + cos(pl->angle) * pl->move_forward
		* M_SPEED + cos(pl->angle + M_PI_2) * pl->move_side * M_SPEED;
	new_p.y = pl->y + sin(pl->angle) * pl->move_forward
		* M_SPEED + sin(pl->angle + M_PI_2) * pl->move_side * M_SPEED;
